...
/**
 * The handful of icons the editor needs that are not in `material-icons-core`.
 *
 ...
 * standard Material 24dp glyphs.
 */
object ForgeIcons {

    val Pause: ImageVector by lazy {
        materialIcon("Forge.Pause") {
            materialPath {
    ...
    /** Used for "ekspor proyek Android" — a robot head is the clearest signal for that action. */
    val Android: ImageVector by lazy {
        materialIcon("Forge.Android") {
            materialPath {
                moveTo(6f, 18f)
